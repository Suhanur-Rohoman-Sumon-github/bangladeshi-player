            ...
            <div className="card card-compact w-full bg-primary shadow-2xl">
                ...
                <div className="card-body bg-black text-white">
                    ...
                    <div className="card-actions justify-end">
                        <button disabled={double} onClick={() => {
                            handlecard(props.plyer); setDouble(true);
                        }} className="btn  btn-primary w-full text-white">Buy Now <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
